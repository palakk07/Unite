...
struct FourthProfileView: View {
    @Environment(\.presentationMode) var presentationMode
    @State private var nationality = ""
    @State private var languages = ""
    @State private var loginButtonTapped = false
    @State private var progressValue = 75.0
    
    private var types: [Interests] = [
        .photography,
        .music,
        .gaming,
        .singing,
    ...
    var body: some View {
        ZStack {
            VStack {
                NavigationLink(destination: FifthProfile(), isActive: $loginButtonTapped) {
                    EmptyView()
                }
                ...
                VStack {
                    ...
                    Text("Nothing breaks the ice better than shared interests - the key to great communication and a strong bond.")
                        .font(.system(size: 13))
...
struct FourthProfileView_Previews: PreviewProvider {
